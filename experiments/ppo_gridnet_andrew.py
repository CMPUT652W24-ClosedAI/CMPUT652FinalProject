        ...
        for step in range(0, args.num_steps):
            ...
            with torch.no_grad():
                ...
                if args.ai:
                    ...
                    p1_action, p1_logprob, p1_entropy, p1_invalid_action_masks, p1_self_critic_hidden = agent.get_action_and_value(
                        p1_obs, envs=envs, invalid_action_masks=p1_mask, device=device
                    )
                    # p2_action, _, _, _, _ = agent2.get_action_and_value(
                    p2_action, p2_logprob, p2_entropy, p2_invalid_action_masks, p2_self_critic_hidden = agent2.get_action_and_value(
                    ...
                    print(f"Step {global_step}: p1 value is {p1_self_critic_hidden}, p2 value is {p2_self_critic_hidden} ")
                    1 + 1
